...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, toggleSidebar }) => {
  ...
  return (
    <div
      className={`bg-white h-screen p-4 pt-6 fixed transition-all duration-300 flex flex-col ${
        isOpen ? "w-54" : "w-16"
      } shadow-md`}
    >
      ...
      <div className="mt-auto">
        <button
          ...
          className={`flex items-center gap-2 p-2 rounded-lg text-sm w-full text-left ${
            pathname === "/logout"
