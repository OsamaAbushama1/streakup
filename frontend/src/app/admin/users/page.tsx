...
const UsersManagement: React.FC = () => {
  ...
  if (loading)
    return (
      <>
        <Metadata title="Users Management" description="View and manage user accounts" />
  ...
  return (
    <>
      <Metadata title="Users Management" description="View user performance and engagement at a glance" />
      <div className="min-h-screen bg-white">
      <div className="w-full px-4 py-6">
