...
const HeroSection: React.FC = () => {
  ...
  return (
    <section
      className="relative flex flex-col items-center justify-center text-center h-[90vh] bg-cover bg-center bg-no-repeat"
      style={{ backgroundImage: "url('/imgs/HeroSection.png')" }}
    >
      <LandingHeader />
      ...
      <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center -mt-[70px]">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-black mb-4 sm:mb-6">
          Level Up Your Creative Skills
        </h1>

        <p className="text-gray-700 max-w-md sm:max-w-lg md:max-w-2xl mb-6 sm:mb-8 text-sm sm:text-base md:text-lg">
