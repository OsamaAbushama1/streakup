...
const HowStreakUpWorks: React.FC = () => {
  ...
  return (
    <section className="bg-white relative flex flex-col items-center justify-center min-h-[60vh] px-4 sm:px-6 md:px-12 lg:px-8 py-6 sm:py-8">
      <div className="container mx-auto xl:max-w-7xl text-center">
        ...
        >
          <motion.div variants={itemVariants} className="relative rounded-lg p-[2px]">
            <div className="bg-[#725BF3] rounded-lg p-4 shadow-lg hover:shadow-xl transition flex flex-col items-center text-center h-full">
          ...
          <motion.div variants={itemVariants} className="relative rounded-lg p-[2px]">
            <div className="bg-[#27DFA6] rounded-lg p-4 shadow-lg hover:shadow-xl transition flex flex-col items-center text-center h-full">
              <div className="w-20 h-20 md:w-24 md:h-24 rounded-full flex items-center justify-center">
                <motion.div variants={pulseVariant} animate="animate">
                  <FaLightbulb className="text-5xl md:text-6xl text-white" />
                </motion.div>
              </div>
          ...
          <motion.div variants={itemVariants} className="relative rounded-lg p-[2px]">
            <div className="bg-[#F6C953] rounded-lg p-4 shadow-lg hover:shadow-xl transition flex flex-col items-center text-center h-full">
              <div className="w-20 h-20 md:w-24 md:h-24 rounded-full flex items-center justify-center">
                <motion.div variants={shakeVariant} animate="animate">
                  <FaTrophy className="text-5xl md:text-6xl text-white" />
                </motion.div>
              </div>
